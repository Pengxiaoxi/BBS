	...
	$("#regForm").validate(
            {
                ...
                rules: {
                	...
                	"user.mobile":{ required: true,number:true,minlength:11,maxlength:11 },
...
function checkNickName(nickName){
	...
	$.post("/User_existUserWithUserName.ashx",{nickName:nickName},
			function(result){
...
<body>
	...
	<div class="" align="center" style="margin-top: 50px;">
		...
		<form runat="server" id="regForm" style="width: 700px;" enctype="multipart/form-data" class="form-horizontal form-inline" >
			<div class="control-group">
				<label class="control-label" for="nickName">昵称(*)：</label>
				<div class="controls">
					<input class="input-block-level" type="text" id="nickName" name="nickName" onblur="checkNickName(this.value)" value="<%= nickname%>"/><span class="pull-left"></span>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input class="input-block-level" type="text" id="trueName" name="user.trueName" onblur="checkTrueName(this.value)" value="<%=truename %>"/><span class="pull-left"></span>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<label class="radio" style="margin-right: 50px;">
						<select id="sex" name="user.sex"><option value="">请选择性别...</option>
			...
			<div class="control-group" id="preDiv" style="width: 700px; height: 120px;margin-left: 80px;">
                <img id="ImgPr" class="pull-left" style="width: 120px; height: 120px;" src="/images/timg.jpg" />
			</div>
			<div class="control-group">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input class="text input-block-level" type="text" id="mobile"
						name="user.mobile" value="<%=mobile %>"/><span class="pull-left"></span>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input class="text input-block-level" type="text" id="email"
						name="user.email" value="<%=email %>"/><span class="pull-left"></span>
				</div>
			</div>
