		...
		<table>
			...
			<tr class="code">
				...
				<td>
                    ...
                    type=text value="" name="imageCode" id="imageCode"><img src="Login_ValidateCode.ashx" onclick="javascript:loadimage()" title="换一张试试" name="randImage"
			...
			<tr>
				<td colspan="2">
					<button type="submit" tabindex="5">登录</button> &nbsp;&nbsp;&nbsp;&nbsp;
						<font id="error" style="font-size: 20px;" color="red"><%=ErrorMsg %></font>            
				</td>
			</tr>
...
<div class="bottom">©2018 蛋炒饭  <a href="javascript:;" target="_blank">关于</a> <span>Asp.net</span><img width="13" height="16" src="images/copy_rignt_24.png" /></div>
