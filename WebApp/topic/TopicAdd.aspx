<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TopicAdd.aspx.cs" Inherits="WebApp.topic.TopicAdd" ValidateRequest="false"  %>
...
<div style="width: 1200px; margin: 0 auto;">
	<table border="0" width="100%" cellspacing="0" cellpadding="0" style="margin-top: 8;width: 1400px;" align="center">
		...
		<tr>
			...
			<td>
				<form class="form-horizontal" style="margin-top: 10px;" runat="server" onsubmit="return checkForm()">
					...
					<div class="control-group">
						...
						<div class="controls">
                            ...
                            <%--<textarea name="topic.content" id="Content" class="" cols="50" style="height: 200px; width: 800px;"></textarea>--%>
						</div>
					</div>
					<input id="user" name="topic.user.id" value="" type="hidden"/>
					...
					<div class="control-group">
						<div class="controls">
							...
							<font style="color:red" id="error" ></font>
						</div>
					</div>
				</form>
			</td>
