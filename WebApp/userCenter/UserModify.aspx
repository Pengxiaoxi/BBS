<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserModify.aspx.cs" Inherits="WebApp.userCenter.UserModify" %>
	...
	<div class="" align="center" style="margin-top: 50px;">
		...
		<form id="regForm" style="width: 700px;" enctype="multipart/form-data" class="form-horizontal form-inline" runat="server">
			<div class="control-group">
				...
				<div class="controls">
					<input class="input-block-level" type="text" id="nickName" name="user.nickName" value="<%=((bbs.Model.User)Session["userInfo"]).nickname %>"/><span class="pull-left"></span>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input class="input-block-level" type="text" id="trueName" name="user.trueName" onblur="checkTrueName(this.value)" value="<%=((bbs.Model.User)Session["userInfo"]).truename %>"/><span class="pull-left"></span>
				</div>
			</div>
			<div class="control-group">
			...
			<div class="control-group" id="preDiv" style="width: 700px; height: 120px;margin-left: 80px;">
                ...
                <%
                    if (((bbs.Model.User)Session["userInfo"]).face != null)
                    {%>
                        <img id="ImgPr" class="pull-left" style="width: 120px; height: 120px;" src="<%=((bbs.Model.User)Session["userInfo"]).face %>" />
                    <%}
                    else
                    {%>
                        <img id="ImgPr" class="pull-left" style="width: 120px; height: 120px;" src="/images/user/female.gif" />
                    <%}
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="hidden" name="user.face" value="<%=((bbs.Model.User)Session["userInfo"]).face %>">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input class="text input-block-level" type="text" id="mobile"
						name="user.mobile" value="<%=((bbs.Model.User)Session["userInfo"]).mobile%>"/><span class="pull-left"></span>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input class="text input-block-level" type="text" id="email"
						name="user.email" value="<%=((bbs.Model.User)Session["userInfo"]).email %>"/><span class="pull-left"></span>
				</div>
			</div>
			<input type="hidden" name="user.type" value="<%=((bbs.Model.User)Session["userInfo"]).type %>">
			<input type="hidden" name="user.id" value="<%=((bbs.Model.User)Session["userInfo"]).id %>">
			<input type="hidden" name="user.regTime" value="<%=((bbs.Model.User)Session["userInfo"]).regtime %>">
